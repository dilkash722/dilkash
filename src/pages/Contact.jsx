  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl text-center">
        ...
        {/* ICON GRID (Mobile 2 per row, Desktop 4 per row) */}
        <div
          className="
            grid 
        ...
        >
          {/* PHONE */}
          <div className="p-6 rounded-2xl border border-yellow-500/30 bg-white/5 backdrop-blur-xl shadow-lg hover:bg-white/10 transition">
            <svg
            ...
            <p className="text-xl font-bold text-yellow-400">Phone</p>
          ...
          <div className="p-6 rounded-2xl border border-yellow-500/30 bg-white/5 backdrop-blur-xl shadow-lg hover:bg-white/10 transition">
            ...
            <p className="text-xl font-bold text-yellow-400">WhatsApp</p>
            <p className="text-gray-300 text-sm">+91 XXXXXXXXXX</p>
          </div>
          ...
          <div className="p-6 rounded-2xl border border-yellow-500/30 bg-white/5 backdrop-blur-xl shadow-lg hover:bg-white/10 transition">
            ...
            <p className="text-xl font-bold text-yellow-400">Email</p>
          ...
          <div className="p-6 rounded-2xl border border-yellow-500/30 bg-white/5 backdrop-blur-xl shadow-lg hover:bg-white/10 transition">
            ...
            <p className="text-xl font-bold text-yellow-400">Court</p>
